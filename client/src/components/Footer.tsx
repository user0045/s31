          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="bg-card/95 backdrop-blur-sm border border-border/30 max-w-md">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 mt-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="description" className="text-foreground">Advertisement Description (Max 1000 words) *</Label>
                  <Textarea
                    id="description"
                    ...
                    className={`bg-background/50 border-border/50 focus:border-primary min-h-[100px] ${errors.description ? 'border-red-500' : ''}`}
                ...
                <div className="space-y-2">
                  <Label htmlFor="budget" className="text-foreground">Budget (INR) - Minimum ₹5,000</Label>
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={`bg-background/50 border-border/50 focus:border-primary pl-8 ${errors.budget ? 'border-red-500' : ''}`}
                      min="5000"
                      step="1"
                      required
                    />
                ...
                <div className="flex space-x-3 pt-4">
                  ...
                  <Button 
                    type="submit" 
                    className="flex-1 bg-primary hover:bg-primary/90 text-primary-foreground hover:scale-105 hover:shadow-lg hover:shadow-primary/25 transition-all duration-300 transform hover:-translate-y-0.5"
                    disabled={createAdvertisementRequest.isPending}
                  >
